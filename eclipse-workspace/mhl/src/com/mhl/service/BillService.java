...
public class BillService {
	...
	//返回所有的账单并带有菜品名,价格 提供给View使用
		public List<MultiTableBean> list2(){//下面sql +拼接起来要有 空格
	...
	public boolean payBill(int diningTableId,String payMode) {
		...
		//如果这里使用事务的话，需要用ThreadLocal来解决，框架中mybatis 提供了事务支持
		//1.修改bill表
		...
		//2.修改diningTable表
		//注意 不要直接在这里操作，而应该调用DiningTableService  方法完成更新，体现各司其职

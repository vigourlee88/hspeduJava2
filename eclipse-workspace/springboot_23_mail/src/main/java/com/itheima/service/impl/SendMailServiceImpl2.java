...
public class SendMailServiceImpl2 implements SendMailService {
	...
	public void sendMail() {
		...
		try {// 发送高端邮件
			...
			MimeMessageHelper helper = new MimeMessageHelper(message, true);// 允许添加多个附件true
			...
			// 添加附件
			File f1 = new File(
					"D:\\eclipse-workspace\\hspeduJava2\\eclipse-workspace\\springboot_23_mail\\target\\springboot_23_mail-0.0.1-SNAPSHOT.jar");
			File f2 = new File(
					"D:\\eclipse-workspace\\hspeduJava2\\eclipse-workspace\\springboot_23_mail\\src\\main\\resources\\logo.png");

...
public class A15 {
    public static void main(String[] args) {
        ...
        pointcut.setExpression("execution(* foo())");//*:匹配任意返回值
        // 2. 备好通知  功能增强 MethodInterceptor函数式接口
        ...
        factory.addAdvisor(advisor);//添加切面(切点，通知)
        factory.setInterfaces(target.getClass().getInterfaces());//设置代理类要实现哪些接口
    ...
    static class Target2 {//no extends I1没有实现接口
        public void foo() {

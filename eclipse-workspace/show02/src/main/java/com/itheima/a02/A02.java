...
//        testAnnotationConfigApplicationContext();
        ...
        reader.loadBeanDefinitions(new FileSystemResource("src\\main\\resources\\a02.xml"));//读取
        for (String name : beanFactory.getBeanDefinitionNames()) {
            System.out.println(name);
        }*/
    ...
    // ⬇️基于磁盘路径下 xml 格式的配置文件来创建,或者使用相对路径src\\main\\resources\\a02.xml
    private static void testFileSystemXmlApplicationContext() {
        FileSystemXmlApplicationContext context =
                new FileSystemXmlApplicationContext(
                        "D:\\hspeduJava2\\eclipse-workspace\\show02\\src\\main\\resources\\a02.xml");
        for (String name : context.getBeanDefinitionNames()) {
            System.out.println(name);
        }
